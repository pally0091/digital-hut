  ...
  return (
    <div className="p-5 ">
      <div>
        ...
        <h1 className="text-xl font-semibold text-center mt-5 border-2 p-2 shadow-md rounded">Here are our categories of products</h1>
      </div>
      ...
      {
            categories.map(category => <h1 className="m-5 bg-indigo-300 shadow-md lg:w-[10%]  p-2 text-center rounded capitalize" key={category}>{category}</h1>)
          }
